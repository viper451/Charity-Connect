...
{/* 
                ...
                <FormGroup>
                    ...
                    <Input type="text" name="organize" value={action.name}  id="organize" placeholder="" />
                </FormGroup>
                ...
                <FormGroup>
                    ...
                    <Input type="text" name="name" value={organizaiton} id="name" placeholder="Enter Name" />
                </FormGroup>

                <FormGroup>
                    <Label for="email">Organization Email</Label>
                    <Input type="email" name="email" value={orgemail} id="email" placeholder="Enter Email" />
                </FormGroup>
