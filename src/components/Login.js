                ...
                <div className="mini-box">
                        {
                            ...
                            <p className="text-center my-3">Don't have an account? <Link to={"/organizationlistlogin"}>Login as Organization </Link> </p>
                            </>
                        }
...
const Logout =()=>{
    ...
    return(
        <>
        <h4 className="text-center">Welcome {!user.name?organizaiton:user.name}</h4>
